            ...
            if "movie" in splitmsg[1]:
                if match is None:
                    ...
                    if countitems > 0:
                        ...
                        await me2.send(message.author.mention + " requested - " + splitmsg[1] + " https://radarr.odrallag.com/add/new?term="+ splitmsg[1].strip())
                        await message.add_reaction("\U00002714")
                ...
                if countitems > 0:
                    ...
                    await me2.send(message.author.mention + " requested - " + splitmsg[1] + " https://sonarr.odrallag.com/add/new?term="+ splitmsg[1].strip())
                    await message.add_reaction("\U00002714")
        else:
